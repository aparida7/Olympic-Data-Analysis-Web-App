...
if user_menu == 'Overall Analysis':
       ...
       fig = px.line(nations_over_time,x='Edition',y='Number of region')
       st.title("Participating Nations Over the Years")
       # Set the title and labels for clarity
       fig.update_layout(
              title="Events Over the Years",
              xaxis_title="Number of region",
              yaxis_title="Edition"
       )
       # Show the figure
       st.plotly_chart(fig)
       ...
       fig = px.line(events_over_time,x='Edition',y='Number of Event')
       ...
       fig = px.line(athlete_over_time, x='Edition', y='Number of Name')
       ...
       # First, create the pivot table and then use astype to convert the data to integers
...
if user_menu == 'Country-wise Analysis':
       ...
       top_10_df = helper.most_successful_athlete_countrywise(df,selected_country)
       st.table(top_10_df)
